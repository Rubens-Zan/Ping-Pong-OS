...
typedef struct
{
  ...
  short cslock; // Lock da secao critica do semaforo, utilizado para que tarefas distintas consigam lidar com a estrutura do semaforo atraves de funcoes de entrada e saida na secao critica 
